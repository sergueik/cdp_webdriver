...
public class MessageBuilder {
	...
	public static String buildEmulationSetUserAgent(int id, final String userAgent) {
	...
	public static String buildPageAddScriptToEvaluateOnNewDocument(int id, final String source) {
	...
	// https://chromedevtools.github.io/devtools-protocol/tot/Emulation/#method-setDeviceMetricsOverride
	public static String buildEmulationSetDeviceMetrics(int id, final int width, final int height,
	...
	public static String buildEmulationSetDeviceMetrics(int id, final int width, final int height,
		...
		return buildEmulationSetDeviceMetrics(id, width, height, scaleFactor, true, 1);
	}
