...
public class DemoTest extends BaseTest {
	...
	public void getRuntimeEvaluateTest() throws MessageTimeOutException {
		...
		try {
			...
			CDPClient.sendMessage(MessageBuilder.buildRuntimeEvaluateMessage(id, "var x = 42; x;", false));
		...
		} catch (WebSocketException | IOException | InterruptedException | MessageTimeOutException e) {
	...
	// @Ignore
	@Test
	public void addScriptToEvaluateOnNewDocumentTest3() throws example.messaging.CDPClient.MessageTimeOutException {
